...
function shuffle() {
    ...
    // "linear-gradient(to right, "+c1+" , yellow);" 요거 안쓰는 방법 ```백틱 따옴표
...
//이벤트 리스너 사용
// color1.addEventListener('click', 함수)  <-'click'은 마우스 좌클릭
css.addEventListener('click', click) //css는 h3이니까 걔를 누르면 아래 알림뜸
css2.addEventListener('dblclick', click2) //이건 더블클릭
function click() {
    alert('클릭');
}
function click2() {
